<?php
 require('css.php');
//  Chức năng này sẽ thay đổi trạng thái của website (đóng hoặc mở) dựa vào field status ở table website,
//  thường dùng khi trong quá trình bảo trì hay nâng cấp.
// Nếu đăng nhập
if ($user)
{
