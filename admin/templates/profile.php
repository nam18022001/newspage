        ...
        <div class="panel-body">
            <form method="POST" onsubmit="return false;" id="formUpdateInfo">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="dn_update" require="" value="' . $data_user['display_name'] . '">
                </div>
                <div class="form-group">
                    <label>Email *</label>
                    <input type="text" class="form-control" id="email_update" require="" value="' . $data_user['email'] . '">
                </div>
                <div class="form-group">
